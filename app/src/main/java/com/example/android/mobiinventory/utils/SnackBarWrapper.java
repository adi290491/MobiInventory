...
public class SnackbarWrapper {
    ...
    {
        this.applicationContext = appplicationContext;
    ...
    public void show(){
        ...
        windowManager.addView(new FrameLayout(applicationContext){
            @Override
    ...
    private void onRootViewAvailable(final FrameLayout rootView) {
        final CoordinatorLayout snackbarContainer = new CoordinatorLayout(new ContextThemeWrapper(applicationContext, R.style.FOL_Theme_SnackbarWrapper)){
            @Override
